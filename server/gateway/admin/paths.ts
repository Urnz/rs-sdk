...
export const simulationClockConfigPath = join(repoRoot, 'config', 'simulation-clock.json');
export const simulationClockDbPath = join(repoRoot, '.local', 'simulation', 'simulation-clock.sqlite');
export const worldGenesisRunDbPath = join(repoRoot, '.local', 'simulation', 'world-genesis-runs.sqlite');
export const worldGenesisProvenanceDbPath = join(repoRoot, '.local', 'simulation', 'world-genesis-provenance.sqlite');
export const worldGenesisProfileCatalogPath = join(repoRoot, 'config', 'world-genesis-profiles.json');
