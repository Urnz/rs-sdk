...
class World {
    ...
    adminTransferProperty(commandId: string, transferId: string, propertyId: string, expectedVersion: number,
        from: { kind: 'player'|'business'|'faction'; id: string }, to: { kind: 'player'|'business'|'faction'; id: string }): AdminPropertyTransferResult {
